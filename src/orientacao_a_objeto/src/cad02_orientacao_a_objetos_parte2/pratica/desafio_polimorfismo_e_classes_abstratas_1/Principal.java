package cad02_orientacao_a_objetos_parte2.pratica.desafio_polimorfismo_e_classes_abstratas_1;
...
Não gostaríamos que a classe Pessoa fosse instanciada em nenhum momento. Para chegar a essa conclusão, é só pensarmos:
...
Se pensarmos nesse mesmo sentido, a classe Conta também está eleita a ser abstrada, afinal, não existe motivo em termos
uma instância apenas de Conta. Vamos analisar: qual seria o sentido de existir um objeto da classe Conta? Que tipo de
conta seria? Conta a pagar? Conta a receber? Temos que transformar a classe Conta também em abstrata!

Achou que o exercício seria apenas isso? Você se enganou! Vamos começar agora o desafio. :)



Você precisa exibir relatórios de contas a pagar e receber, pois ajudará no controle do que tem para pagar e receber na
...
Ao fazer isso, você será obrigado a implementar esse novo método nas subclasses ContaPagar e ContaReceber. Então, faça

package cad01_operadores.teoria;

public class ATT02_OPERADORES_INCREMENTO_E_DECREMENTO {
    public static void main(String[] args) {
        ...
        // Primeiro incrementa e depois passa o valor para a variável "numero02"

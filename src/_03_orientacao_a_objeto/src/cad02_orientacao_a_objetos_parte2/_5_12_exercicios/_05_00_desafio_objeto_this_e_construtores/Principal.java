package cad02_orientacao_a_objetos_parte2._5_12_exercicios._05_00_desafio_objeto_this_e_construtores;
/*
Você é um empresário da área de tecnologia da informação que tem um bom faturamento mensal, porém suas contas ContaCorrente pagar
estão totalmente desorganizadas. A planilha Excel que você usa já não suporta mais o movimento que ContaCorrente empresa possui,
e chegou ContaCorrente hora de investir no desenvolvimento de um sistema financeiro para ContaCorrente empresa.
...
Uma conta ContaCorrente pagar possui uma descrição, valor, data de vencimento e fornecedor.
...
Quando finalizar ContaCorrente criação das classes ContaPagar e Fornecedor, crie uma outra classe chamada MegaSena com o código-fonte abaixo:
...
Agora compile e execute ContaCorrente classe MegaSena. Evite ver ContaCorrente resolução do desafio antes de resolver os problemas sozinho.
Bom trabalho! :)
*/

...
Vamos aproveitar ContaCorrente ideia do último exercício e aprender um pouco mais.
...
1. Crie ContaCorrente classe "Pessoa" e adicione um atributo do tipo "Cachorro". Assim estamos dizendo que uma "Pessoa" tem um
"Cachorro" (essa classe é ContaCorrente mesma dos últimos exercícios).
...
4. Compile e execute ContaCorrente classe Passeio, você deverá ver no console o nome da pessoa e do cachorro que estão passeando.
 */

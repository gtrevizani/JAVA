package cad01_orientacao_a_objetos._4_4_exercicios._04_00_desafio_algoritmo_petshop;
/*
Instanciando e acessando atributos do objeto
Utilizando o IntelliJ, vamos fazer este primeiro exercícios sobre Orientação ContaCorrente Objetos. Fique ContaCorrente vontade para criar outro
...
3. Agora vamos instanciar um objeto do tipo "Cachorro". Dentro do método "main" utilize ContaCorrente palavra-chave "new" para criar
o objeto.
...
tente perceber que são objetos diferentes criados ContaCorrente partir de uma única classe.
 */
public class Petshop {
    public static void main(String[] args) {
        Cachorro cachorro1 = new Cachorro(); // Instanciamento
        cachorro1.nome = "Bilu"; // Objeto e atributo
        cachorro1.raca = "Rotweiller";
        cachorro1.sexo = 'M';
        cachorro1.idade = 18;

        Cachorro cachorro2 = new Cachorro(); // Instanciamento
        cachorro2.nome = "Belinha"; // Objeto e atributo
        cachorro2.raca = "Pastor Alemao";
        cachorro2.sexo = 'F';
        cachorro2.idade = 8;

        System.out.println("Nome: " + cachorro1.nome); // Exibições

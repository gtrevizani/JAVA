...
public class ContaPagar extends Conta{
    ...
    public void pagar() throws OperacaoContaException{
        if (SituacaoConta.PAGA.equals(this.getSituacaoConta())) {
            throw new OperacaoContaException("Não pode pagar uma conta que já está paga: " // Método com parâmetro
                    + this.getDescricao() + ".");
        } else if (SituacaoConta.CANCELADA.equals(this.getSituacaoConta())) {
            throw new OperacaoContaException("Não pode pagar uma conta que está cancelada: " // Método com parâmetro
                    + this.getDescricao() + ".");
        } else {
